...
```bash
scp .env macmini:/root/DockerContainer/keeper-coc-trpg/.env && ssh macmini "export PATH=\$PATH:/snap/bin && cd /root/DockerContainer/keeper-coc-trpg && python3 restart.py"
```
